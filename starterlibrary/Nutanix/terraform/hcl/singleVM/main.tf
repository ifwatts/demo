#####################################################################
##
##      Created 4/11/19 by ifwatts@ca.ibm.com.
##
#####################################################################
...
variable "description" {
  ...
  default = "demo Frontend Web Server"
}
...
variable "memory_size_mib" {
  type = "string"
  description = "Virtual Machine Memory (mib)"
  default = "4096"
}
...
variable "source_uri" {
  type = "string"
  description = "Disk Image URI for the Virtual Machine"
  default = "http://endor.dyn.nutanix.com/acro_images/DISKs/cirros-0.3.4-x86_64-disk.img"
}
variable "local_cluster" {
  type = "string"
  description = "local cluster ID"
  default = "00054051-250f-5ccc-0000-00000000cf0d"
}
...
output "vm-ip" {
  value = "${nutanix_virtual_machine.demo-01-web.ip_address}"
}
